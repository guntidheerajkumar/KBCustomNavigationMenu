...
/*!
 Dropdown view state.
 */
typedef NS_ENUM(NSUInteger, KBDropdownViewState) {
    KBDropdownViewStateWillOpen,
    KBDropdownViewStateDidOpen,
    KBDropdownViewStateWillClose,
    KBDropdownViewStateDidClose,
};

typedef NS_ENUM(NSUInteger, KBDropdownViewDirection) {
    KBDropdownViewDirectionTop,
    KBDropdownViewDirectionBottom,
};

@protocol KBDropdownViewDelegate;
 ...
 */
@property (nonatomic, assign) KBDropdownViewDirection direction;
 ...
 */
@property (nonatomic, assign, readonly) KBDropdownViewState currentState;
...
/*!
 *  Convenience constructor for KBDropdownView.
 */
